...
const pattern6 = /^<img\src="(https:\/\/.{2,}\.png)"\/>$/;
...
const pattern7 = /^<img\src="(https:\/\/.{2,}\.(png|jpg))"\/>$/;
...
console.log(pattern13.test(contraseñaFacil));
...
console.log(pattern14.test(contraseñaDificil));
